...
##04-spring-boot-rest-crud-employee-with-spring-data-REST -To samo tylko konfigurowanie wszystkich endpointów można uzyskać przy pomocy Springa zależnością Spring REST DATA.
